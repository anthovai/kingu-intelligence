...
export type KinguMobileWebShellViewProps = ViewProps & {
  /**
  ...
  /**
   * The page posted `json` through `window.kinguBridge`. Native has already refused anything from
...
export type KinguMobileWebShellViewHandle = {
  /**
 ...
 */
export const KinguMobileWebShellView: ComponentType<
  KinguMobileWebShellViewProps & RefAttributes<KinguMobileWebShellViewHandle>
