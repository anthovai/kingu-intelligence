...
type TerminalGestureSurface = HTMLElement & { __kinguSurfaceHandlersAttached?: boolean }
...
export function attachSurfaceEventHandlers(
  ...
  if (!targetSurface || targetSurface.__kinguSurfaceHandlersAttached) {
    return
  }
  targetSurface.__kinguSurfaceHandlersAttached = true
