...
const JOURNAL_STORAGE_KEY = 'kingu:mobile-relay:pairing-journal:v1'
const JOURNAL_SECRET_KEY = 'kingu.mobile-relay.pairing-journal.v1'
...
function requireNativeSecretStore(): void {
  if (Platform.OS === 'web') {
    throw new Error('Kingu Relay pairing requires a native secret store')
  }
}
