...
const GENERATION_STORAGE_KEY = 'kingu:pairing-keychain-generation'
const PRESENCE_STORAGE_PREFIX = 'kingu:pairing-keychain-presence:'
const SERVICE_PREFIX = 'kingu.pairing.v'
