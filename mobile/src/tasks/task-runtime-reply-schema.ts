 ...
 * optional at every read (:283 spells `uiState?.trustedKinguHooks ?? {}`, :284
 ...
 * opaque forwards: `trustedKinguHooks` goes straight into state, and `taskResumeState` is the
  ...
  .looseObject({
    ui: salvagedOptional(
      ...
      z.looseObject({
        ...
        trustedKinguHooks: z.unknown().optional()
      })
    )
  })
  .nullish()
