...
vi.mock('@react-native-async-storage/async-storage', () => ({
  default: {
    ...
    setItem: async () => {
      if (store.refuse) {
        throw new Error(
          'Kingu could not save kingu:custom-accessory-keys: a stored value may be too large.'
        )
      }
    }
  }
...
const CUSTOM_KEYS = 'kingu:custom-accessory-keys'
 ...
 *
 * `kingu:custom-accessory-keys` is in the session route's page allowlist, and on the page a write
