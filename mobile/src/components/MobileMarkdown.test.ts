...
<h1 align="center">
  <a href="https://onKingu.dev"><img src="resources/build/icon.png" alt="Kingu" width="64" /></a>
  Kingu
</h1>

<p align="center">
  <a href="https://github.com/anthovai/kingu-intelligence/stargazers"><img src="https://badgen.net/github/stars/anthovai/kingu-intelligence" alt="GitHub stars" /></a>
...
`)
  ...
  it('preserves non-tag angle bracket prose while stripping known HTML tags', () => {
    ...
    expect(normalizeMobileMarkdownPreviewHtml('<mailto:kingu@example.com>')).toBe(
      '<mailto:kingu@example.com>'
    )
  ...
  it('does not replace literal code placeholder text in markdown prose', () => {
    const literalPlaceholder = '\uE000KINGU_MD_CODE_0\uE000'
