...
import { parseMobileWebShellLoadState } from '../../modules/kingu-mobile-web-shell/src/load-state'
...
export function screenModuleMocks(dependencies: ScreenDependencies) {
  return {
    ...
    '../../modules/kingu-mobile-web-shell/src': () => {
      return {
        KinguMobileWebShellView: (props: {
          sessionId: string
