...
import type { KinguMobileWebShellViewProps } from '../../modules/kingu-mobile-web-shell/src'
...
vi.mock('@kingu/expo-two-way-audio', () => ({
...
vi.mock('../../modules/kingu-mobile-web-shell/src', async () => {
  ...
  return {
    KinguMobileWebShellView: (props: KinguMobileWebShellViewProps) =>
