 ...
 */
export type KinguBridgePageChannel = {
 ...
 */
export function readKinguBridgePageChannel(): KinguBridgePageChannel | null {
  const scope: typeof globalThis & { kinguBridge?: KinguBridgePageChannel } = globalThis
  const channel = scope.kinguBridge
 ...
 */
export function createKinguBridgePageTransport(
  channel: KinguBridgePageChannel
