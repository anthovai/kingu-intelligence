...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  {
    ...
    steps: [
      'Check that system settings allow Kingu notifications and that Focus or Do Not Disturb is off.',
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow Kingu.',
      'Windows: Defender Firewall → Allow app — enable Kingu for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'Kingu must be open on your desktop to accept connections.',
      'Try restarting Kingu — the companion server starts on launch.',
