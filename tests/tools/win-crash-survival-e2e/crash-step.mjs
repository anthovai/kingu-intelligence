...
//
// GitHub #7742: when Kingu's main/renderer process died on Windows, the terminal
 ...
 * or image-named process, so a live user Kingu on the same box is never touched.
 */
