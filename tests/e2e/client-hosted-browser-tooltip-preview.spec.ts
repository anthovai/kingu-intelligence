...
// Run: KINGU_TOOLTIP_PREVIEW=1 pnpm exec playwright test --config tests/playwright.config.ts \
...
test.skip(
  process.env.KINGU_TOOLTIP_PREVIEW !== '1',
  'Preview only; run with KINGU_TOOLTIP_PREVIEW=1'
)
