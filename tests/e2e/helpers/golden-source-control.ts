...
export const GOLDEN_GIT_AUTHOR_NAME = 'Kingu E2E'
export const GOLDEN_GIT_AUTHOR_EMAIL = 'kingu-e2e@example.invalid'
...
export function installPassingNodePreCommitHook(fixture: GoldenWorktree): string {
  const hooksPath = mkdtempSync(path.join(os.tmpdir(), 'kingu-e2e-git-hooks-'))
