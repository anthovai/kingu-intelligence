...
additional boundaries in [#20960](https://github.com/anthovai/kingu-intelligence/pull/20960).

## Reproduce

```sh
KINGU_BACKGROUND_LAUNCH=1 node --expose-gc docs/audits/pty-detector-retention/reproduce.mjs
```
...
16 Ki characters. The actual main feed is `kingu-runtime-on-pty-data.ts` and the
