...
const variant = process.env.KINGU_CLOSED_MODEL_VARIANT ?? 'fixed'
...
vi.mock('../../../src/renderer/src/components/editor/EditorPanel', async () => {
  ...
  return {
    default:
      (process.env.KINGU_CLOSED_MODEL_VARIANT ?? 'fixed') === 'before'
