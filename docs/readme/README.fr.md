...
<p align="center">
  <a href="https://github.com/anthovai/kingu-intelligence"><img src="https://badgen.net/github/stars/anthovai/kingu-intelligence?label=%E2%98%85" alt="Étoiles GitHub" /></a>
  <a href="https://github.com/anthovai/kingu-intelligence/releases"><img src="../assets/readme-downloads.svg" alt="Téléchargements totaux sur toutes les versions" /></a>
  <img src="https://badgen.net/github/license/anthovai/kingu-intelligence" alt="Licence" />
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="Rejoindre le Discord Kingu" /></a>
  <a href="https://x.com/kingu_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="Suivre Kingu sur X" /></a>
...
<h3 align="center"><a href="https://onkingu.dev/download"><ins>Télécharger Kingu</ins></a></h3>

<p align="center">
  <sub>Sous Windows ? Prenez la <a href="https://github.com/anthovai/kingu-intelligence/releases#release-v1.4.147-rc.3">dernière RC</a> — elle inclut des correctifs Windows.</sub>
</p>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="Application de bureau Kingu exécutant des agents dans des worktrees parallèles, avec l'app companion mobile Kingu dans le coin" width="960" />
</p>
...
[App Store iOS](https://apps.apple.com/us/app/kingu-ide/id6766130217) · [TestFlight](https://testflight.apple.com/join/YjeGMQBA) · [APK Android 0.0.48](https://github.com/anthovai/kingu-intelligence/releases/download/mobile-android-v0.0.48/app-release.apk) · [Docs →](https://www.onkingu.dev/docs/mobile)

</td>
<td width="50%">
  <a href="https://www.onkingu.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="Kingu desktop avec l'app companion mobile" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onkingu.dev/docs/model/worktrees"><picture><source srcset="../site/public/docs/tab-split.gif" type="image/gif"><img src="../site/public/docs/posters/tab-split.jpg" alt="Orchestration de worktrees parallèles" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onkingu.dev/docs/terminal"><picture><source srcset="../../resources/onboarding/feature-wall/tile-02.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-02.poster.jpg" alt="Splits de terminal" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onkingu.dev/docs/browser/design-mode"><picture><source srcset="../site/public/docs/kingu-design-mode.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-05.poster.jpg" alt="Navigateur intégré et Mode Design" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onkingu.dev/docs/review/linear"><picture><source srcset="../../resources/onboarding/feature-wall/tile-03.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-03.poster.jpg" alt="Workflows GitHub et Linear dans Kingu" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onkingu.dev/docs/ssh"><picture><source srcset="../../resources/onboarding/feature-wall/tile-06.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-06.poster.jpg" alt="Worktrees distants via SSH" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Posez des commentaires sur n'importe quelle ligne de diff et renvoyez-les à l'agent — review, édition et commit sans quitter Kingu.

[Docs →](https://www.onkingu.dev/docs/review/annotate-ai-diff)

</td>
<td width="50%">
  <a href="https://www.onkingu.dev/docs/review/annotate-ai-diff"><picture><source srcset="../site/public/docs/annotate-ai-diff.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-08.poster.jpg" alt="Annoter les diffs générés par l'IA" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onkingu.dev/docs/editing/file-explorer"><picture><source srcset="../../resources/onboarding/feature-wall/tile-07.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-07.poster.jpg" alt="Glisser des fichiers et images dans le prompt d'un agent" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Les agents pilotent aussi Kingu — scriptez n'importe quel workflow avec `kingu worktree create`, `snapshot`, `click` et `fill`.

[Docs →](https://www.onkingu.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.onkingu.dev/docs/cli/overview"><picture><source srcset="../../resources/onboarding/feature-wall/tile-09.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-09.poster.jpg" alt="Scripter Kingu depuis la CLI" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **[Quick open](https://www.onkingu.dev/docs/model/quick-open)** — Cherchez parmi worktrees, fichiers, agents, commandes et contexte du repo sans quitter votre flow.
- **[Sélecteur de comptes &amp; suivi d'usage](https://www.onkingu.dev/docs/agents/usage-tracking)** — Suivez l'usage Claude et Codex et les resets de rate limit, et basculez de compte à chaud sans vous reconnecter.
- **[Aperçus riches du repo](https://www.onkingu.dev/docs/editing/markdown)** — Prévisualisez Markdown, images, PDF et docs du repo dans le workspace.
- **[Computer Use](https://www.onkingu.dev/docs/cli/computer-use)** — Laissez les agents piloter des apps desktop et l'UI visible quand un workflow demande une vraie interaction.
- **[Notifications et non-lus](https://www.onkingu.dev/docs/notifications)** — Sachez quand un agent termine ou a besoin d'attention, puis marquez des fils comme non lus pour y revenir plus tard.
- **Et bien plus encore** — on ship tous les jours, donc cette liste est toujours en retard. Le [changelog](https://github.com/anthovai/kingu-intelligence/releases) est la vraie liste des features.

---

## Agents pris en charge

Fonctionne avec **n'importe quel agent CLI** — s'il tourne dans un terminal, il tourne dans Kingu.
...
- **[Télécharger depuis onKingu.dev](https://onkingu.dev/download)**
- Ou récupérez un build directement : [macOS Apple Silicon](https://github.com/anthovai/kingu-intelligence/releases/latest/download/kingu-macos-arm64.dmg) · [macOS Intel](https://github.com/anthovai/kingu-intelligence/releases/latest/download/kingu-macos-x64.dmg) · [Windows (.exe)](https://github.com/anthovai/kingu-intelligence/releases/download/v1.4.147-rc.3/kingu-windows-setup.exe) · [Linux AppImage](https://github.com/anthovai/kingu-intelligence/releases/latest/download/kingu-linux.AppImage) · [Tous les builds](https://github.com/anthovai/kingu-intelligence/releases/latest)
- **Sous Windows :** utilisez la [dernière RC (`v1.4.147-rc.3`)](https://github.com/anthovai/kingu-intelligence/releases#release-v1.4.147-rc.3) — elle inclut des correctifs Windows absents de la stable.
- Vous lancez `kingu serve` sur un serveur Linux headless ? Consultez le [guide serveur Linux headless](../reference/headless-linux-server.md).
...
# Arch Linux (AUR) — ou stably-kingu-git pour compiler depuis les sources
...
- **iOS :** [Télécharger sur l'App Store](https://apps.apple.com/us/app/kingu-ide/id6766130217) ou [rejoindre TestFlight](https://testflight.apple.com/join/YjeGMQBA)
- **Android :** [Télécharger l'APK 0.0.48](https://github.com/anthovai/kingu-intelligence/releases/download/mobile-android-v0.0.48/app-release.apk)
...
- **Twitter / X :** Suivez **[@kingu_build](https://x.com/kingu_build)** pour les news et annonces.
- **WeChat :** Scannez pour rejoindre le groupe WeChat 8 de la communauté Kingu. Le groupe 8 est peut-être complet ; dans ce cas, scannez plutôt le QR code du groupe 9.

  <img src="../assets/wechat-qr-group8.jpg" alt="QR code WeChat groupe 8 de la communauté Kingu" width="160" />&nbsp;&nbsp;<img src="../assets/wechat-qr-group9.jpg" alt="QR code WeChat groupe 9 de la communauté Kingu" width="160" />

- **Feedback &amp; idées :** On ship vite. Il manque quelque chose ? [Demandez une feature](https://github.com/anthovai/kingu-intelligence/issues).
- **Confidentialité :** Voir la [doc confidentialité &amp; télémétrie](https://www.onkingu.dev/docs/telemetry) pour ce qu'Kingu collecte en anonyme et comment désactiver la télémétrie.
- **Soutenez-nous :** [Mettez une star](https://github.com/anthovai/kingu-intelligence) sur ce repo pour suivre nos ships quotidiens.
...
<a href="https://github.com/anthovai/kingu-intelligence/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=anthovai/kingu-intelligence" alt="Contributeurs Kingu" />
</a>

<p align="center">
  <img src="../assets/star-history.png" alt="Graphique d'historique des étoiles GitHub pour anthovai/kingu-intelligence" width="880" />
</p>
...
Kingu est libre et open source sous la [licence MIT](../../LICENSE).
