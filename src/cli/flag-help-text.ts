...
export const FLAG_HELP_TEXT: Record<string, string> = {
  ...
  comment: '--comment <text>       Comment stored in Kingu metadata',
  ...
  activate: '--activate             Reveal the new worktree in the Kingu app',
  ...
  'display-name': '--display-name <name>  Override the Kingu display name',
  ...
  focus: '--focus                Reveal the created terminal session in Kingu',
  ...
  current: '--current              Use the current Kingu worktree linked Linear issue',
  ...
  page: '--page <id>            Stable browser page id from `kingu tab list --json`',
