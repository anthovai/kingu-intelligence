...
describe('skill command specs', () => {
  ...
  it('documents the per-reference selector beside --full', () => {
    ...
    expect(help).toContain('Usage: kingu skills get <topic> [--full | --reference <name>] [--json]')
    ...
    expect(help).toContain('kingu skills get orchestration --reference recovery-and-cleanup')
