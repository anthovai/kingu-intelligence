...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['serve'],
    summary: 'Start an Kingu runtime server without opening a desktop window',
    usage:
    ...
    examples: [
      'kingu serve',
      'kingu serve --json',
      'kingu serve --project-root /workspace/repo --pairing-address wss://sandbox.example.com --recipe-json',
      'kingu serve --port 6768 --pairing-address 100.64.1.20',
      'kingu serve --pairing-address 100.64.1.20 --mobile-pairing'
    ]
  }
]
