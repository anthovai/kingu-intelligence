...
export const LINEAR_MCP_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'kingu linear save-issue [<id>] [--current] [--team <key|id>] [--title <title>] [--description <text> | --body-file <path|->] [--state <state>] [--assignee me|<user>|null] [--priority none|low|medium|high|urgent] [--estimate <number>|null] [--due-date <yyyy-mm-dd>|null] [--label <label>...] [--project <project>|null] [--parent-id <issue>|null] [--write-id <uuid>] [--workspace <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'current',
      'team',
    ...
    examples: [
      ...
      'kingu linear save-issue ENG-123 --title "Fix OAuth callback" --assignee me --json',
  ...
  },
  {
    ...
    examples: [
      ...
      'kingu linear list-issues --query auth --updated-at -P7D --json',
      'kingu linear list-issues --assignee me --priority 1 --limit 100 --json',
      'kingu linear list-issues --cursor <cursor> --json'
    ],
    notes: [
  ...
  },
  {
    ...
    usage:
      'kingu linear relation add [<id>] [--current] --related <issue> --type blocks|blocked-by|related|duplicate-of [--workspace <id>] [--json]',
    ...
    examples: [
      ...
      'kingu linear relation add --current --related ENG-2 --type blocked-by --json'
    ]
  },
  {
    ...
    usage:
      'kingu linear relation remove [<id>] [--current] --related <issue> --type blocks|blocked-by|related|duplicate-of [--workspace <id>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'related', 'type', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['kingu linear relation remove ENG-1 --related ENG-2 --type related --json']
  }
]
