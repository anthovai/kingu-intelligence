export const ROOT_HELP_TEXT_PRIMARY = [
  'kingu',
  '',
  'Usage: kingu <command> [options]',
  '',
  'Startup:',
  '  open                      Launch Kingu and wait for the runtime to be reachable',
  '  serve                     Start a headless Kingu runtime server',
  '  status                    Show app/runtime/graph readiness',
  '',
  'Diagnostics:',
  '  diagnostics memory        Collect a memory snapshot for Kingu and managed terminals',
  '',
  'Agent Discovery:',
  ...
  '  skills list               List version-matched skill guides bundled with this Kingu CLI',
  '  skills get                Print a version-matched skill guide as Markdown',
  '  skills install            Install bundled Kingu skills globally via the community skills CLI',
  '  skills update             Update already-installed Kingu skills via the community skills CLI',
  '',
  'Hosts:',
  '  host list                 List targetable machines and how to name each one',
  '',
  'Environments:',
  '  environment add           Save a remote Kingu runtime from a pairing code',
  '  environment list          List saved remote Kingu runtimes',
  '  environment show          Show one saved remote Kingu runtime',
  '  environment rm            Remove a saved remote Kingu runtime',
  '',
  'Environment Recipes:',
  '  vm recipe doctor          Validate a per-workspace environment recipe',
  '',
  'Automations:',
  '  automations list          List scheduled Kingu automations',
  '  automations show          Show one Kingu automation',
  '  automations create        Create a scheduled Kingu automation',
  '  automations edit          Edit an Kingu automation',
  '  automations remove        Remove an Kingu automation and its run history',
  '  automations run           Run an Kingu automation now',
  '  automations runs          List automation run history',
  '',
  'Projects:',
  '  project list              List durable projects known to Kingu',
  ...
  '',
  'Repos:',
  '  repo list                 List repos registered in Kingu',
  '  repo add                  Add a project to Kingu by filesystem path',
  ...
  '',
  'Worktrees:',
  '  worktree list             List Kingu-managed worktrees',
  '  worktree show             Show one worktree',
  '  worktree current          Show the Kingu-managed worktree for the current directory',
  '  worktree create           Create a new Kingu-managed worktree',
  '  worktree set              Update Kingu metadata for a worktree',
  '  worktree rm               Remove a worktree from Kingu and git',
  '  worktree ps               Show a compact orchestration summary across worktrees',
  '',
  'Files:',
  '  file open                 Open a workspace file in the Kingu editor',
  '  file diff                 Open a workspace file diff in the Kingu editor',
  '  file open-changed         Open all git-changed files for a workspace',
  '',
  'Terminals:',
  '  terminal list             List live Kingu-managed terminals',
  ...
  '  emulator list             List available/running emulators (Kingu-managed + raw serve-sim)',
