...
// Asserts that the telemetry compile-time constants — `KINGU_BUILD_IDENTITY`
// and `KINGU_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/Kingu.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/Kingu.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `KINGU_BUILD_IDENTITY` and `KINGU_POSTHOG_WRITE_KEY` with their
