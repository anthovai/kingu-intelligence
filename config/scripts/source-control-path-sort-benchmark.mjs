...
const ITERATIONS = Number(process.env.KINGU_SC_SORT_BENCH_ITERATIONS ?? '25')
const WARMUP = Number(process.env.KINGU_SC_SORT_BENCH_WARMUP ?? '5')

for (const [name, value] of [
  ['KINGU_SC_SORT_BENCH_ITERATIONS', ITERATIONS],
  ['KINGU_SC_SORT_BENCH_WARMUP', WARMUP]
]) {
