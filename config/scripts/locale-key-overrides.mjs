...
const BASE_LOCALE_KEY_OVERRIDES = {
  ...
  'menu.showMobileButton': {
    ko: 'Kingu 모바일 버튼 표시',
    zh: '显示 Kingu Mobile 按钮',
    ja: 'Kingu Mobile ボタンを表示'
  },
  ...
  'menu.exploreKingu': { ko: 'Kingu 둘러보기', zh: '探索 Kingu', ja: 'Kingu を探索' },
  ...
  // Onboarding pill beside Kingu Mobile: "New" marks a new feature, not a create action.
