...
# anthovai/kingu-intelligence-hourly. GITHUB_TOKEN cannot be used: it is scoped to the repo
...
# Widening it to cover anthovai/kingu-intelligence-adhoc / kingu-daily is
...
MAIN_REPO="anthovai/kingu-intelligence"
...
──────────────────────────────────────────────────────
  1. Open:  https://github.com/organizations/anthovai/settings/apps/new
  2. Name ..................  kingu-hourly-release
