...
export const LOCALE_PHRASE_FIXES = {
  ...
  zh: [
    ...
    { pattern: /虎鲸:\/\//g, replacement: 'kingu://', whenEnIncludes: 'kingu://' },
    ...
    { pattern: /连接到Kingu/g, replacement: '连接到 Kingu', whenEnIncludes: 'Connect to Kingu' },
    {
      pattern: /开始使用Kingu/g,
      replacement: '开始使用 Kingu',
      whenEnIncludes: 'get started with Kingu'
    },
