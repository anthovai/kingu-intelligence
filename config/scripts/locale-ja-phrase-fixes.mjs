...
// Two-word commands (`git commit`, `kingu terminal`) must keep their second word in Latin.
const COMMAND_HEAD = '(?<!\\b(?:git|gh|glab|kingu|npm|pnpm|npx|yarn|docker|kubectl) )'
...
export const JA_PHRASE_FIXES = [
  ...
  { pattern: /シャチ:\/\//g, replacement: 'kingu://', whenEnIncludes: 'kingu://' },
  ...
  { pattern: /崩壊させる/g, replacement: '折りたたむ', whenEnIncludes: 'Collapse Kingu' },
  ...
  { pattern: /再起動します/g, replacement: '再起動', whenEnIncludes: 'Restart Kingu' },
  ...
  // Kingu's host covers SSH hosts and this computer; skipped where the English also says server.
  {
