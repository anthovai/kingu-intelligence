...
export const FIRST_MARKER = 'KINGU-TERMINAL-RENDER-FIRST'
export const LAST_MARKER = 'KINGU-TERMINAL-RENDER-LAST'
...
export default function TerminalProbeRoute() {
  ...
  const onSelectionCopy = useCallback((text) => {
    globalThis.__kinguTerminalCopied = text
  }, [])
  const onWebReady = useCallback(() => {
    globalThis.__kinguTerminalReady = true
  }, [])
  const onEngineError = useCallback((message) => {
    globalThis.__kinguTerminalEngineErrors.push(message)
  }, [])
  useEffect(() => {
    globalThis.__kinguTerminalEngineErrors = globalThis.__kinguTerminalEngineErrors ?? []
    globalThis.__kinguTerminalBeforeInput = []
    globalThis.__kinguTerminalProbe = {
    ...
    const onBeforeInput = (event) => {
      globalThis.__kinguTerminalBeforeInput.push({
...
export default function ControlRoute() {
  globalThis.__kinguTerminalControlMounted = true
