...
export const ZH_VALUE_OVERRIDES = {
  ...
  'Kingu IDE': 'Kingu IDE',
  'Kingu first': 'Kingu 优先',
  'Kingu Mobile': 'Kingu Mobile',
  'Kingu logo': 'Kingu 标志',
  'Enjoying Kingu?': '喜欢 Kingu 吗？',
  'Get to know Kingu': '了解 Kingu',
  'Expand Kingu': '展开 Kingu',
  'Support Kingu': '支持 Kingu',
  'Restarting Kingu…': '正在重启 Kingu…',
  'Show Kingu Mobile Button': '显示 Kingu Mobile 按钮',
  ...
  'Proxy Command': '代理命令',
  "Give agents direct access to Kingu's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 Kingu 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from Kingu. It is still on your disk.': '来自 Kingu。它仍保留在您的磁盘上。',
