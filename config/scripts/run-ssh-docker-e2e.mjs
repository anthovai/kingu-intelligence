...
const env = {
  ...process.env,
  KINGU_E2E_SSH_DOCKER: '1',
  KINGU_E2E_LOCAL_SSH_BROWSER: '1',
  KINGU_E2E_SSH_CLIENT_HOSTED_BROWSER: '1',
  KINGU_E2E_WEB_CLIENT: '1'
}
...
// Why one explicit list: these specs self-skip without KINGU_E2E_SSH_DOCKER and no sharded lane
...
//       nested-runtime-ssh-lifecycle, nested-runtime-ssh-routing (KINGU_E2E_NESTED_RUNTIME_SSH)
