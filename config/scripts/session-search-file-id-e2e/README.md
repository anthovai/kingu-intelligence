...
- The child's allowlisted environment includes `KINGU_BACKGROUND_LAUNCH=1`.
...
This is not a packaged/full Kingu desktop launch. The host and scanner are bundled
