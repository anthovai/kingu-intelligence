...
describe('isDirectInvocation', () => {
  ...
  it('matches a Windows entry path, which the file:// template form never does', () => {
    const scriptPath = 'C:\\kingu\\config\\scripts\\build-mobile-web-app-bundle.mjs'
    const moduleUrl = 'file:///C:/kingu/config/scripts/build-mobile-web-app-bundle.mjs'
...
describe('running a builder through a symlink', () => {
  ...
  it('still recognises the entry module', async () => {
    const scratch = await mkdtemp(join(tmpdir(), 'kingu-script-entry-link-'))
    try {
