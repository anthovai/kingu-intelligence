...
const temp = mkdtempSync(join(tmpdir(), 'kingu-daemon-scope-lifetime-'))
const suffix = `${process.pid}-${Date.now()}`
const image = `kingu-daemon-scope-lifetime:${suffix}`
const container = `kingu-daemon-scope-lifetime-${suffix}`
const platform =
...
try {
  ...
  runDocker([
    ...
    [
      ...
      'loginctl enable-linger kingu-repro',
