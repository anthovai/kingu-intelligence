...
export const ZH_PHRASE_FIXES_ROUND5 = [
  { pattern: /Kingu集成开发环境/g, replacement: 'Kingu IDE', whenEnIncludes: 'Kingu IDE' },
  { pattern: /Kingu第一/g, replacement: 'Kingu 优先', whenEnIncludes: 'Kingu first' },
  { pattern: /Kingu移动/g, replacement: 'Kingu Mobile', whenEnIncludes: 'Kingu Mobile' },
  { pattern: /Kingu标志/g, replacement: 'Kingu 标志', whenEnIncludes: 'Kingu logo' },
  { pattern: /喜欢Kingu/g, replacement: '喜欢 Kingu', whenEnIncludes: 'Enjoying Kingu' },
  { pattern: /认识Kingu/g, replacement: '了解 Kingu', whenEnIncludes: 'Get to know Kingu' },
  { pattern: /支持Kingu/g, replacement: '支持 Kingu', whenEnIncludes: 'Support Kingu' },
  { pattern: /展开Kingu/g, replacement: '展开 Kingu', whenEnIncludes: 'Expand Kingu' },
  { pattern: /来自Kingu/g, replacement: '来自 Kingu', whenEnIncludes: 'from Kingu' },
  {
    pattern: /正在重新启动Kingu/g,
    replacement: '正在重启 Kingu',
    whenEnIncludes: 'Restarting Kingu'
  },
  { pattern: /Kingu([\u4e00-\u9fff])/g, replacement: 'Kingu $1', whenEnIncludes: 'Kingu' },
  ...
  {
    pattern: /显示 Kingu 移动按钮/g,
    replacement: '显示 Kingu Mobile 按钮',
    whenEnIncludes: 'Show Kingu Mobile Button'
  }
]
