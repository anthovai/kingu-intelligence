...
`kingu_relay_postgres_query_failed` separates failure to acquire a pooled connection
...
Use structured GCE logs with `jsonPayload.event="kingu_relay_postgres_query_failed"`.
